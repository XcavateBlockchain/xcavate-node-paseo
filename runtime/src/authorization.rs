...
impl<AttesterId, DelegationAc, DelegationId, Ctype, ClaimHash>
    AttestationAccessControl<AttesterId, AuthorizationId<DelegationId>, Ctype, ClaimHash>
    ...
    DelegationAc: AttestationAccessControl<AttesterId, DelegationId, Ctype, ClaimHash>,
{
    ...
    fn can_revoke(
        ...
        let (PalletAuthorize::Delegation(ac), AuthorizationId::Delegation(delegation_id)) =
            (self, auth_id);
