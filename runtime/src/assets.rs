...
use crate::{authorization::AuthorizationId, types::Hash, AccountId, Balance, BlockNumber};
...
impl
    ItemFilter<
        CredentialEntry<Hash, AccountId, BlockNumber, AccountId, Balance, AuthorizationId<Hash>>,
