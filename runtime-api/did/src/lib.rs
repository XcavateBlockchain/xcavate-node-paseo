...
/// implementation.
pub type RawDidLinkedInfo<DidIdentifier, AccountId, LinkableAccountId, Balance, Key, BlockNumber> =
    DidLinkedInfo<
        DidIdentifier,
        AccountId,
        LinkableAccountId,
...
sp_api::decl_runtime_apis! {
    #[api_version(4)]
    pub trait Did<DidIdentifier, AccountId, LinkableAccountId, Balance, Key, BlockNumber, RuntimeCall> where
        DidIdentifier: Codec,
        AccountId: Codec,
