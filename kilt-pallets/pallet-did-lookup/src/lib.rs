...
pub mod pallet {
    ...
    pub(crate) type ConnectionRecordOf<T, I> =
        ConnectionRecord<DidIdentifierOf<T, I>, AccountIdOf<T>, BalanceOf<T, I>>;
    ...
    pub trait Config<I: 'static = ()>: frame_system::Config {
        ...
        type AssociateOrigin: EnsureOrigin<
    ...
    pub type ConnectedAccounts<T: Config<I>, I: 'static = ()> = StorageDoubleMap<
        _,
        Blake2_128Concat,
        DidIdentifierOf<T, I>,
        Blake2_128Concat,
            ...
            Into<LinkableAccountId> + From<sp_runtime::AccountId32> + Into<sp_runtime::AccountId32>,
    {
        ...
        pub fn remove_account_association(
            origin: OriginFor<T>,
            ...
            let connection_record =
                ConnectedDids::<T, I>::get(&account).ok_or(Error::<T, I>::NotFound)?;
        ...
        pub fn update_deposit(origin: OriginFor<T>, account: LinkableAccountId) -> DispatchResult {
            ...
            LinkableAccountDepositCollector::<T, I>::update_deposit::<BalanceMigrationManagerOf<T, I>>(
                &account,
            )
        }
    ...
    impl<T: Config<I>, I: 'static> Pallet<T, I> {
        pub fn add_association(
            ...
            let deposit = Deposit { owner: sender, amount: T::Deposit::get() };
            ...
            if is_unique_flag_enabled {
                let is_did_already_linked =
                    ConnectedAccounts::<T, I>::iter_key_prefix(&did_identifier).next().is_some();
            ...
            ConnectedDids::<T, I>::mutate(&account, |did_entry| -> DispatchResult {
                if let Some(old_connection) = did_entry.replace(record) {
                    ...
                    Self::deposit_event(Event::<T, I>::AssociationRemoved(
                        account.clone(),
                        old_connection.did,
                    ));
        ...
        pub(crate) fn remove_association(account: LinkableAccountId) -> DispatchResult {
            if let Some(connection) = ConnectedDids::<T, I>::take(&account) {
                let is_key_migrated =
                    <T as Config<I>>::BalanceMigrationManager::is_key_migrated(&ConnectedDids::<
                        T,
                        I,
                    >::hashed_key_for(
                        &account
    ...
    pub(crate) struct LinkableAccountDepositCollector<T: Config<I>, I: 'static = ()>(
        PhantomData<(T, I)>,
    );
    impl<T: Config<I>, I: 'static>
        StorageDepositCollector<
            AccountIdOf<T>,
            LinkableAccountId,
            <T as Config<I>>::RuntimeHoldReason,
