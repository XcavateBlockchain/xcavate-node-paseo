...
use crate::{
    mock::*, Config, CredentialIdOf, CredentialSubjects, Credentials, Error, HoldReason,
    InputClaimsContentOf,
};
#[test]
fn add_successful_without_authorization() {
    ...
    let credential_id_1: CredentialIdOf<Test> =
        generate_credential_id::<Test>(&new_credential_1, &attester);
    let new_credential_2 = generate_base_public_credential_creation_op::<Test>(
        subject_id.into(),
        ctype_hash_2,
        InputClaimsContentOf::<Test>::default(),
    );
    let credential_id_2: CredentialIdOf<Test> =
        generate_credential_id::<Test>(&new_credential_2, &attester);
    ...
    ExtBuilder::default()
        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            let stored_public_credential_details =
                Credentials::<Test>::get(subject_id, credential_id_1)
            ...
            let stored_public_credential_details =
                Credentials::<Test>::get(subject_id, credential_id_2)
