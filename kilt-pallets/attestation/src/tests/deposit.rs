        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            assert_eq!(
                Attestation::attestations(claim_hash)
                    ...
                    .deposit,
                Deposit { owner: ACCOUNT_01, amount: <Test as Config>::Deposit::get() }
            );
...
fn test_change_deposit_owner_unauthorized() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute_with_sanity_tests(|| {
            assert_noop!(
                Attestation::change_deposit_owner(
                    DoubleOrigin(ACCOUNT_00, evil_actor).into(),
                    claim_hash
                ),
        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            assert_eq!(
                Attestation::attestations(claim_hash)
                    .expect("Attestation must be retained")
                    .deposit,
                Deposit { owner: ACCOUNT_00, amount: <Test as Config>::Deposit::get() }
            );
...
fn test_reclaim_deposit_authorization() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            assert_ok!(Attestation::reclaim_deposit(RuntimeOrigin::signed(ACCOUNT_00), claim_hash));
            ...
            assert_eq!(
                ...
                vec![
                    Event::AttestationRevoked {
                        ...
                        claim_hash,
                        ctype_hash,
                        authorized_by: attestation::authorized_by::AuthorizedBy::DepositOwner(
                            ACCOUNT_00
                        )
                    },
