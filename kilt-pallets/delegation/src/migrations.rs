...
use crate::{
    AccountIdOf, Config, CurrencyOf, DelegationNodeIdOf, DelegationNodes, Error, HoldReason,
};
...
pub mod test {
    ...
    use crate::{
        migrations::update_balance_for_delegation, mock::*, AccountIdOf, Config, DelegationNodes,
        Error, HoldReason,
    };
        ...
        ExtBuilder::default()
            ...
            .build_and_execute_with_sanity_tests(|| {
                ...
                let balance_on_hold = <<Test as Config>::Currency as InspectHold<
                    AccountIdOf<Test>,
                >>::balance_on_hold(
                    &HoldReason::Deposit.into(), &ACCOUNT_01
                );
