...
fn create_root_delegation_successful() {
    ...
    let operation =
        generate_base_delegation_hierarchy_creation_operation::<Test>(hierarchy_root_id);
    ...
    ExtBuilder::default()
        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            let stored_delegation_root = Delegation::delegation_nodes(hierarchy_root_id)
...
fn create_delegation_direct_root_successful() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            let stored_delegation = Delegation::delegation_nodes(operation.delegation_id)
...
fn create_delegation_with_parent_successful() {
    ...
    ExtBuilder::default()
        ...
        .build_and_execute_with_sanity_tests(|| {
            ...
            let stored_parent = Delegation::delegation_nodes(operation.parent_id)
                .expect("Delegation parent be present on chain.");
