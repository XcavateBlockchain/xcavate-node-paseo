...
use crate::{
    ...
    utils as crate_utils, AccountIdOf, Config, CurrencyOf, DidBlacklist, DidEndpointsCount,
    HoldReason, KeyIdOf, ServiceEndpoints,
};
...
pub(crate) fn get_attestation_key_call() -> RuntimeCall {
    RuntimeCall::Ctype(ctype::Call::add { ctype: get_attestation_key_test_input() })
}
