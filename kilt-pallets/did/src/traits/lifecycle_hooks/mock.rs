...
use crate::{
    Config, DeriveDidCallAuthorizationVerificationKeyRelationship,
    DeriveDidCallKeyRelationshipResult, DidVerificationKeyRelationship,
};
...
parameter_types! {
    #[derive(TypeInfo, Debug, PartialEq, Eq, Clone, Encode, Decode, DecodeWithMemTracking)]
...
impl DeriveDidCallAuthorizationVerificationKeyRelationship for RuntimeCall {
    ...
    fn get_call_for_did_call_benchmark() -> Self {
        Self::System(frame_system::Call::remark { remark: b"test".to_vec() })
    }
}
