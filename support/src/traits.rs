...
pub trait StorageDepositCollector<AccountId, Key, RuntimeHoldReason> {
            ...
            BalanceMigrationManager<AccountId, <Self::Currency as Inspect<AccountId>>::Balance>,
    {
        ...
        if is_key_migrated {
            ...
            DepositBalanceMigrationManager::release_reserved_deposit(
                &deposit.owner,
                &deposit.amount,
            );
        ...
        let deposit_with_new_owner = Deposit { owner: new_owner, ..deposit };
            ...
            BalanceMigrationManager<AccountId, <Self::Currency as Inspect<AccountId>>::Balance>,
    {
        ...
        let deposit_with_new_amount = Deposit { amount: Self::deposit_amount(key), ..deposit };
        Self::Currency::hold(
            &reason.into(),
