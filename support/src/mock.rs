...
use frame_support::traits::{
    fungible::{
        Balanced, Dust, Inspect, InspectHold, Mutate, MutateHold, Unbalanced, UnbalancedHold,
    },
    tokens::{
        Balance as BalanceT, DepositConsequence, Fortitude, Preservation, Provenance,
        WithdrawConsequence,
    },
};
...
pub mod mock_origin {
    ...
    /// WARNING: This is only used for testing!
    #[derive(
        Debug, Clone, PartialEq, Eq, TypeInfo, Encode, Decode, DecodeWithMemTracking, MaxEncodedLen,
    )]
...
impl<AccountId, Balance, RuntimeHoldReason> MutateHold<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    Balance: BalanceT,
...
impl<AccountId, Balance, RuntimeHoldReason> UnbalancedHold<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    Balance: BalanceT,
    RuntimeHoldReason: Encode + TypeInfo + 'static,
...
impl<AccountId, Balance, RuntimeHoldReason> InspectHold<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    Balance: BalanceT,
    RuntimeHoldReason: Encode + TypeInfo + 'static,
...
impl<AccountId, Balance, RuntimeHoldReason> Mutate<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    AccountId: Eq,
    Balance: BalanceT,
...
impl<AccountId, Balance, RuntimeHoldReason> Inspect<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    Balance: BalanceT,
{
...
impl<AccountId, Balance, RuntimeHoldReason> Unbalanced<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    Balance: BalanceT,
{
...
impl<AccountId, Balance, RuntimeHoldReason> Balanced<AccountId>
    for MockCurrency<Balance, RuntimeHoldReason>
where
    Balance: BalanceT,
{
